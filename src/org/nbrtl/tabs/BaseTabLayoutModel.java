...
class BaseTabLayoutModel implements TabLayoutModel {
    ...
    public int getX(int index) {
        // Shlomi.v - RTL support
        // got a little lazy with the controlWidth
        int result = renderTarget.getWidth()-BasicScrollingTabDisplayerUI.controlWidth-10;
